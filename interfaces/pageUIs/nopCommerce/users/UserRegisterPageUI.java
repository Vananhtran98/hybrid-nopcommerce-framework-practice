...
public class UserRegisterPageUI {
    ...
    public static final String COMPANY_TEXTBOX = "Css=input[id='Company']";
    ...
    public static final String REGISTER_LOGOUT_LINK = "XPATH=//a[@class='ico-logout']";

    public static final String REGISTER_LOGIN_LINK = "XPATH=//a[@class='ico-login']";
